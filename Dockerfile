...
# Install apktool
# Get the latest apktool version from its official repository
ENV APKTOOL_VERSION=2.9.3 # Check for the latest version on https://ibotpeaches.github.io/Apktool/install/
...
# Get the latest uber-apk-signer version from its GitHub releases
ENV UBER_APK_SIGNER_VERSION=1.3.0 # Check for the latest version on https://github.com/patrickfav/uber-apk-signer/releases
